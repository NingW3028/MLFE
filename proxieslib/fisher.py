...
import types
import copy
from proxieslib.p_utils import get_layer_metric_array, reshape_elements
...
def compute_fisher_per_weight(net, inputs, targets, loss_fn=nn.CrossEntropyLoss(), mode='channel', split_data=1):
